...
public class PolicyService {
    ...
    public BookingPolicy getActivePolicy() {
        ...
        // Return the first active policy (you could add logic to select by
        // priority/role)
    ...
    public PolicyValidationResponse validateBooking(ValidatePolicyRequest request) {
        ...
        // Check if booking is in the past (with 2-minute grace period for request
        // latency)
        LocalDateTime graceBuffer = now.minusMinutes(2);
        if (startTime.isBefore(graceBuffer)) {
